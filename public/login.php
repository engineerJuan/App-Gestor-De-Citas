...
<div class="d-flex justify-content-center align-items-center" style="min-height: 70vh;">
    <div class="card shadow-lg border-0 p-4" style="width: 28rem; border-radius: 25px;">
        <div class="card-body">
            <h2 class="text-center fw-bold mb-4 text-primary">Agenda Médica</h2>
            ...
            <form id="formLogin">
                <div class="input-group mb-3 py-1">
                    ...
                    <input type="text" id="userInput" class="form-control border-start-0" placeholder="Nombre de usuario" required>
                </div>
...
document.getElementById('formLogin').addEventListener('submit', async (e) => {
    ...
    if (data.success) {
        ...
        document.getElementById('loginAlert').innerHTML = `<div class="alert alert-danger py-2 small text-center">${data.message}</div>`;
        btn.disabled = false;
